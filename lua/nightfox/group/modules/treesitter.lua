...
function M.get(spec, config, opts)
  ...
  local hl = {
    ...
    ["@tag"] = { fg = syn.tag },                                           -- XML-style tag names (and similar)
    ["@tag.builtin"] = { fg = syn.tag },                                   -- XML-style tag names (and similar)
    ["@tag.builtin.tsx"] = { fg = syn.tag },                               -- XML-style tag names (and similar)
    ["@tag.attribute"] = { fg = syn.tag, style = "italic" },               -- XML-style tag attributes
